...
import { SegnivoCustom } from "./client-custom";

export class Segnivo extends SegnivoCustom {
  readonly emailAddressVerification: EmailAddressVerificationApi;
  readonly emailCampaigns: EmailCampaignsApi;
  readonly mailingLists: MailingListsApi;
  readonly relay: RelayApi;
  readonly relayTransactionalEmails: RelayTransactionalEmailsApi;
  readonly subscribersContacts: SubscribersContactsApi;

  constructor(configurationParameters: ConfigurationParameters) {
    super(configurationParameters);
    const configuration = new Configuration(configurationParameters);
    this.emailAddressVerification = new EmailAddressVerificationApi(configuration);
    this.emailCampaigns = new EmailCampaignsApi(configuration);
    this.mailingLists = new MailingListsApi(configuration);
    this.relay = new RelayApi(configuration);
    this.relayTransactionalEmails = new RelayTransactionalEmailsApi(configuration);
    this.subscribersContacts = new SubscribersContactsApi(configuration);
  }
