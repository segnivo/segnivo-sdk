...
/**
 * This class provides a wrapper for network errors when making requests to Segnivo Developer API
 */
export class SegnivoError extends Error {
  /**
   * The response body
   */
