...
from segnivo import rest
from segnivo.api_response import ApiResponse, AsyncApiResponse
from segnivo.rest import AsyncResponseWrapper, ResponseWrapper
from segnivo.configuration import Configuration
from segnivo.exceptions import ApiTypeError, ApiValueError, MissingRequiredParametersError
from segnivo.request_after_hook import request_after_hook
from segnivo.request_before_url_hook import request_before_url_hook
from segnivo.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Konfig/1.7.1/python'
