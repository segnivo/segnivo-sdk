...
from segnivo.paths.validate_email.post import EmailPost
from segnivo.apis.tags.email_address_verification_api_raw import EmailAddressVerificationApiRaw
...
class EmailAddressVerificationApiGenerated(
    ...
    """
    raw: EmailAddressVerificationApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = EmailAddressVerificationApiRaw(api_client)
