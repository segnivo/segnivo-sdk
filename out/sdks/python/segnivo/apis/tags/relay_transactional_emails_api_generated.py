...
from segnivo.paths.relay_send.post import RelaySendPost
from segnivo.apis.tags.relay_transactional_emails_api_raw import RelayTransactionalEmailsApiRaw
...
class RelayTransactionalEmailsApiGenerated(
    ...
    """
    raw: RelayTransactionalEmailsApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = RelayTransactionalEmailsApiRaw(api_client)
