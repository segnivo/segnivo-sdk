...
class BaseApi(api_client.Api):
    ...
    def _lists_uid_get_mapped_args(
        self,
        uid: str,
    ...
    async def _alists_uid_get_oapg(
        self,
...
class ListsUidGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alists_uid_get(
        self,
        uid: str,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._lists_uid_get_mapped_args(
            uid=uid,
            accept=accept,
        )
        return await self._alists_uid_get_oapg(
    ...
    def lists_uid_get(
        ...
        return self._lists_uid_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListsUidGet(BaseApi):
    ...
    async def alists_uid_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alists_uid_get(
            uid=uid,
            accept=accept,
            **kwargs,
        )
    ...
    def lists_uid_get(
        ...
        raw_response = self.raw.lists_uid_get(
            uid=uid,
            accept=accept,
        )
        if validate:
