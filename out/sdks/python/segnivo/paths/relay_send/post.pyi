...
class BaseApi(api_client.Api):
    ...
    def _relay_send_post_mapped_args(
        self,
    ...
    async def _arelay_send_post_oapg(
        self,
...
class RelaySendPostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arelay_send_post(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._relay_send_post_mapped_args(
        )
        return await self._arelay_send_post_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def relay_send_post(
        ...
        return self._relay_send_post_oapg(
            body=args.body,
        )

class RelaySendPost(BaseApi):
    ...
    async def arelay_send_post(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arelay_send_post(
            **kwargs,
        )
        if validate:
    ...
    def relay_send_post(
        ...
        raw_response = self.raw.relay_send_post(
        )
        if validate:
            return Dictionary(**raw_response.body)
        return api_client.construct_model_instance(Dictionary, raw_response.body)
