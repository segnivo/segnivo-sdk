...
class BaseApi(api_client.Api):
    ...
    def _contacts_uid_patch_mapped_args(
        self,
        uid: str,
    ...
    async def _acontacts_uid_patch_oapg(
        self,
...
class ContactsUidPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontacts_uid_patch(
        self,
        uid: str,
        content_type: typing.Optional[str] = None,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._contacts_uid_patch_mapped_args(
            uid=uid,
            content_type=content_type,
            accept=accept,
        )
        return await self._acontacts_uid_patch_oapg(
            body=args.body,
    ...
    def contacts_uid_patch(
        ...
        return self._contacts_uid_patch_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ContactsUidPatch(BaseApi):
    ...
    async def acontacts_uid_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontacts_uid_patch(
            uid=uid,
            content_type=content_type,
            accept=accept,
            **kwargs,
    ...
    def contacts_uid_patch(
        ...
        raw_response = self.raw.contacts_uid_patch(
            uid=uid,
            content_type=content_type,
            accept=accept,
        )
