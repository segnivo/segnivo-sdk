...
class ListsGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alists_get(
        self,
        accept: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._lists_get_mapped_args(
            accept=accept,
        )
        return await self._alists_get_oapg(
    ...
    def lists_get(
        ...
        return self._lists_get_oapg(
            header_params=args.header,
        )

class ListsGet(BaseApi):
    ...
    async def alists_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alists_get(
            accept=accept,
            **kwargs,
        )
        if validate:
    ...
    def lists_get(
        ...
        raw_response = self.raw.lists_get(
            accept=accept,
        )
        if validate:
            return Dictionary(**raw_response.body)
