...
class BaseApi(api_client.Api):
    ...
    def _messages_uid_get_mapped_args(
        self,
        uid: str,
    ...
    async def _amessages_uid_get_oapg(
        self,
...
class MessagesUidGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amessages_uid_get(
        self,
        uid: str,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._messages_uid_get_mapped_args(
            uid=uid,
            accept=accept,
        )
        return await self._amessages_uid_get_oapg(
    ...
    def messages_uid_get(
        ...
        return self._messages_uid_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class MessagesUidGet(BaseApi):
    ...
    async def amessages_uid_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amessages_uid_get(
            uid=uid,
            accept=accept,
            **kwargs,
        )
    ...
    def messages_uid_get(
        ...
        raw_response = self.raw.messages_uid_get(
            uid=uid,
            accept=accept,
        )
        if validate:
