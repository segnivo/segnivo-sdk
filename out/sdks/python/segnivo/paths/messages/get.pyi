...
class MessagesGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amessages_get(
        self,
        accept: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._messages_get_mapped_args(
            accept=accept,
        )
        return await self._amessages_get_oapg(
    ...
    def messages_get(
        ...
        return self._messages_get_oapg(
            header_params=args.header,
        )

class MessagesGet(BaseApi):
    ...
    async def amessages_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amessages_get(
            accept=accept,
            **kwargs,
        )
        if validate:
    ...
    def messages_get(
        ...
        raw_response = self.raw.messages_get(
            accept=accept,
        )
        if validate:
            return Dictionary(**raw_response.body)
