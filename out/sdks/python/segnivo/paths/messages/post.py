...
class BaseApi(api_client.Api):
    ...
    def _messages_post_mapped_args(
        self,
    ...
    async def _amessages_post_oapg(
        self,
...
class MessagesPostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amessages_post(
        self,
        content_type: typing.Optional[str] = None,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._messages_post_mapped_args(
            content_type=content_type,
            accept=accept,
        )
        return await self._amessages_post_oapg(
            body=args.body,
    ...
    def messages_post(
        ...
        return self._messages_post_oapg(
            body=args.body,
            header_params=args.header,
        )

class MessagesPost(BaseApi):
    ...
    async def amessages_post(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amessages_post(
            content_type=content_type,
            accept=accept,
            **kwargs,
        )
    ...
    def messages_post(
        ...
        raw_response = self.raw.messages_post(
            content_type=content_type,
            accept=accept,
        )
        if validate:
