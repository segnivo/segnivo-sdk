...
from segnivo.client_custom import ClientCustom
from segnivo.configuration import Configuration
from segnivo.api_client import ApiClient
from segnivo.type_util import copy_signature
...
class Segnivo(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.email_address_verification: EmailAddressVerificationApi = EmailAddressVerificationApi(api_client)
        self.email_campaigns: EmailCampaignsApi = EmailCampaignsApi(api_client)
        self.mailing_lists: MailingListsApi = MailingListsApi(api_client)
        self.relay: RelayApi = RelayApi(api_client)
        self.relay_transactional_emails: RelayTransactionalEmailsApi = RelayTransactionalEmailsApi(api_client)
        self.subscribers_contacts: SubscribersContactsApi = SubscribersContactsApi(api_client)
