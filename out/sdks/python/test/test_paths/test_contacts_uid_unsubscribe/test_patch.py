...
import segnivo
from segnivo.paths.contacts_uid_unsubscribe import patch
from segnivo import configuration, schemas, api_client

from .. import ApiTestMixin


class TestContactsUidUnsubscribe(ApiTestMixin, unittest.TestCase):
    """
    ContactsUidUnsubscribe unit test stubs
