...
# Query params
ListUidSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'list_uid': typing.Union[ListUidSchema, str, ],
    },
    total=False
)
...
request_query_list_uid = api_client.QueryParameter(
    name="list_uid",
    style=api_client.ParameterStyle.FORM,
    schema=ListUidSchema,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    ...
    def _contacts_uid_unsubscribe_patch_mapped_args(
        self,
        uid: str,
        accept: typing.Optional[str] = None,
        list_uid: typing.Optional[str] = None,
        ...
        if list_uid is not None:
            _query_params["list_uid"] = list_uid
    ...
    async def _acontacts_uid_unsubscribe_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/{uid}/unsubscribe',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _contacts_uid_unsubscribe_patch_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class ContactsUidUnsubscribePatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontacts_uid_unsubscribe_patch(
        self,
        uid: str,
        accept: typing.Optional[str] = None,
        list_uid: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._contacts_uid_unsubscribe_patch_mapped_args(
            uid=uid,
            accept=accept,
            list_uid=list_uid,
        )
        return await self._acontacts_uid_unsubscribe_patch_oapg(
            body=args.body,
    ...
    def contacts_uid_unsubscribe_patch(
        ...
        return self._contacts_uid_unsubscribe_patch_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
...
class ContactsUidUnsubscribePatch(BaseApi):
    ...
    async def acontacts_uid_unsubscribe_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontacts_uid_unsubscribe_patch(
            uid=uid,
            accept=accept,
            list_uid=list_uid,
            **kwargs,
    ...
    def contacts_uid_unsubscribe_patch(
        ...
        raw_response = self.raw.contacts_uid_unsubscribe_patch(
            uid=uid,
            accept=accept,
            list_uid=list_uid,
        )
