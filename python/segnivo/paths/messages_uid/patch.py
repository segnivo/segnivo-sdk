...
class BaseApi(api_client.Api):
    ...
    def _messages_uid_patch_mapped_args(
        self,
        uid: str,
    ...
    async def _amessages_uid_patch_oapg(
        self,
...
class MessagesUidPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amessages_uid_patch(
        self,
        uid: str,
        content_type: typing.Optional[str] = None,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._messages_uid_patch_mapped_args(
            uid=uid,
            content_type=content_type,
            accept=accept,
        )
        return await self._amessages_uid_patch_oapg(
            body=args.body,
    ...
    def messages_uid_patch(
        ...
        return self._messages_uid_patch_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class MessagesUidPatch(BaseApi):
    ...
    async def amessages_uid_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amessages_uid_patch(
            uid=uid,
            content_type=content_type,
            accept=accept,
            **kwargs,
    ...
    def messages_uid_patch(
        ...
        raw_response = self.raw.messages_uid_patch(
            uid=uid,
            content_type=content_type,
            accept=accept,
        )
