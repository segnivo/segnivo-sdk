...
class BaseApi(api_client.Api):
    ...
    def _relay_emails_id_get_mapped_args(
        self,
        id: str,
    ...
    async def _arelay_emails_id_get_oapg(
        self,
...
class RelayEmailsIdGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arelay_emails_id_get(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._relay_emails_id_get_mapped_args(
            id=id,
            limit=limit,
        )
        return await self._arelay_emails_id_get_oapg(
    ...
    def relay_emails_id_get(
        ...
        return self._relay_emails_id_get_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RelayEmailsIdGet(BaseApi):
    ...
    async def arelay_emails_id_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arelay_emails_id_get(
            id=id,
            limit=limit,
            **kwargs,
        )
    ...
    def relay_emails_id_get(
        ...
        raw_response = self.raw.relay_emails_id_get(
            id=id,
            limit=limit,
        )
        if validate:
