...
class BaseApi(api_client.Api):
    ...
    def _contacts_uid_get_mapped_args(
        self,
        uid: str,
    ...
    async def _acontacts_uid_get_oapg(
        self,
...
class ContactsUidGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontacts_uid_get(
        self,
        uid: str,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._contacts_uid_get_mapped_args(
            uid=uid,
            accept=accept,
        )
        return await self._acontacts_uid_get_oapg(
    ...
    def contacts_uid_get(
        ...
        return self._contacts_uid_get_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ContactsUidGet(BaseApi):
    ...
    async def acontacts_uid_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontacts_uid_get(
            uid=uid,
            accept=accept,
            **kwargs,
        )
    ...
    def contacts_uid_get(
        ...
        raw_response = self.raw.contacts_uid_get(
            uid=uid,
            accept=accept,
        )
        if validate:
