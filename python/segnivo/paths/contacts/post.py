...
class BaseApi(api_client.Api):
    ...
    def _contacts_post_mapped_args(
        self,
    ...
    async def _acontacts_post_oapg(
        self,
...
class ContactsPostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acontacts_post(
        self,
        content_type: typing.Optional[str] = None,
        accept: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._contacts_post_mapped_args(
            content_type=content_type,
            accept=accept,
        )
        return await self._acontacts_post_oapg(
            body=args.body,
    ...
    def contacts_post(
        ...
        return self._contacts_post_oapg(
            body=args.body,
            header_params=args.header,
        )

class ContactsPost(BaseApi):
    ...
    async def acontacts_post(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acontacts_post(
            content_type=content_type,
            accept=accept,
            **kwargs,
        )
    ...
    def contacts_post(
        ...
        raw_response = self.raw.contacts_post(
            content_type=content_type,
            accept=accept,
        )
        if validate:
