...
import segnivo
from segnivo.paths.contacts_uid_subscribe import patch
from segnivo import configuration, schemas, api_client

from .. import ApiTestMixin


class TestContactsUidSubscribe(ApiTestMixin, unittest.TestCase):
    """
    ContactsUidSubscribe unit test stubs
        Subscribe a contact
    """
