 ...
 * no description
 */
export class RelayTransactionalEmailsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param body 
     */
    public async relaySendPost(body?: any, _options?: Configuration): Promise<RequestContext> {
...
export class RelayTransactionalEmailsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to relaySendPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async relaySendPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
