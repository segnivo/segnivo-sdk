 ...
 * no description
 */
export class RelayApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async relayEmailsIdGet(id: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("RelayApi", "relayEmailsIdGet", "id");
        }
     ...
     * @param signDkim 
     */
    public async relayRawPost(message?: string, isTransactional?: boolean, trackClick?: boolean, trackOpen?: boolean, signDkim?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (isTransactional !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('is_transactional', isTransactional as any);
        }
        if (trackClick !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('track_click', trackClick as any);
        }
        if (trackOpen !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('track_open', trackOpen as any);
        }
        if (signDkim !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('sign_dkim', signDkim as any);
        }
...
export class RelayApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to relayEmailsIdGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async relayEmailsIdGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to relayRawPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async relayRawPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
