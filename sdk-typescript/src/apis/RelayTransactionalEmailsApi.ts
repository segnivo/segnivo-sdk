...
import {
    RelayEmailRequestFromJSON,
    RelayEmailRequestToJSON,
} from '../models/index';

export interface RelaySendPostRequest {
 ...
 * 
 */
export class RelayTransactionalEmailsApi extends runtime.BaseAPI {
     ...
     * Send an Email
     */
    async relaySendPostRaw(requestParameters: RelaySendPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        ...
        const response = await this.request({
            ...
            body: RelayEmailRequestToJSON(requestParameters['relayEmailRequest']),
        }, initOverrides);
     ...
     * Send an Email
     */
    async relaySendPost(requestParameters: RelaySendPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.relaySendPostRaw(requestParameters, initOverrides);
