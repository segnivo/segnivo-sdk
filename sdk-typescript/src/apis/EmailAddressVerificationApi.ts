...
import {
    EmailAddressVerificationRequestFromJSON,
    EmailAddressVerificationRequestToJSON,
} from '../models/index';

export interface ValidateEmailPostRequest {
 ...
 * 
 */
export class EmailAddressVerificationApi extends runtime.BaseAPI {
     ...
     */
    async validateEmailPostRaw(requestParameters: ValidateEmailPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        ...
        const response = await this.request({
            ...
            body: EmailAddressVerificationRequestToJSON(requestParameters['emailAddressVerificationRequest']),
        }, initOverrides);
     ...
     * Email Address Verification Validation
     */
    async validateEmailPost(requestParameters: ValidateEmailPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.validateEmailPostRaw(requestParameters, initOverrides);
