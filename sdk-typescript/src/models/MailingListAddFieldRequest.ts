...
/**
 * Check if a given object implements the MailingListAddFieldRequest interface.
 */
export function instanceOfMailingListAddFieldRequest(value: object): value is MailingListAddFieldRequest {
...
export function MailingListAddFieldRequestFromJSON(json: any): MailingListAddFieldRequest {
    return MailingListAddFieldRequestFromJSONTyped(json, false);
}

export function MailingListAddFieldRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MailingListAddFieldRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function MailingListAddFieldRequestToJSON(json: any): MailingListAddFieldRequest {
    return MailingListAddFieldRequestToJSONTyped(json, false);
}

export function MailingListAddFieldRequestToJSONTyped(value?: MailingListAddFieldRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
