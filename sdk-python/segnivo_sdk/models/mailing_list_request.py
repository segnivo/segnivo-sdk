...
class MailingListRequest(BaseModel):
    ...
    MailingListRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the email template or campaign. This is used for internal identification and organization.")
    from_email: StrictStr = Field(description="The sender's email address that will appear in the \"From\" field of the email.")
    from_name: StrictStr = Field(description="The sender's name that will appear in the \"From\" field of the email.")
    contact: Optional[MailingListRequestContact] = None
    __properties: ClassVar[List[str]] = ["name", "from_email", "from_name", "contact"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": MailingListRequestContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None
        })
        return _obj
