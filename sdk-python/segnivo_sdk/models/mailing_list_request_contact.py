...
class MailingListRequestContact(BaseModel):
    """
    Contact details for the email sender or organization. Used for compliance with email regulations (e.g., CAN-SPAM).
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The email address of the sender or organization. Usually used for replies or compliance purposes.")
    company: Optional[StrictStr] = Field(default=None, description="The name of the organization sending the email.")
    __properties: ClassVar[List[str]] = ["email", "company"]
