...
class ContactUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Updated email address")
    first_name: Optional[StrictStr] = Field(default=None, description="Updated first name")
    last_name: Optional[StrictStr] = Field(default=None, description="Updated last name")
    __properties: ClassVar[List[str]] = ["email", "first_name", "last_name"]
