...
class EmailAddressVerificationRequest(BaseModel):
    """
    EmailAddressVerificationRequest
    """ # noqa: E501
    emails: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=50)]] = Field(default=None, description="List of email addresses to validate")
