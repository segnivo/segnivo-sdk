...
class TestMailingListRequestContact(unittest.TestCase):
    """MailingListRequestContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailingListRequestContact:
        """Test MailingListRequestContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailingListRequestContact`
        """
        model = MailingListRequestContact()
        if include_optional:
            return MailingListRequestContact(
    ...
    def testMailingListRequestContact(self):
        """Test MailingListRequestContact"""
