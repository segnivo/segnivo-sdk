...
class TestRelayEmailRequest(unittest.TestCase):
    """RelayEmailRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelayEmailRequest:
        """Test RelayEmailRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelayEmailRequest`
        """
        model = RelayEmailRequest()
        if include_optional:
            return RelayEmailRequest(
                subject = '',
                from_name = '',
                from_email = '',
                reply_to = '',
    ...
    def testRelayEmailRequest(self):
        """Test RelayEmailRequest"""
