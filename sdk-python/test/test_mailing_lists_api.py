...
class TestMailingListsApi(unittest.TestCase):
    ...
    def test_lists_uid_add_field_post(self) -> None:
        """Test case for lists_uid_add_field_post

        Add a field
        """
        pass

    def test_lists_uid_delete_post(self) -> None:
        """Test case for lists_uid_delete_post

        Delete a list
        """
        pass

    def test_lists_uid_get(self) -> None:
        """Test case for lists_uid_get

        Get a list
        """
        pass

    def test_lists_uid_patch(self) -> None:
        """Test case for lists_uid_patch
