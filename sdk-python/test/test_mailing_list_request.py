...
class TestMailingListRequest(unittest.TestCase):
    """MailingListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailingListRequest:
        """Test MailingListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailingListRequest`
        """
        model = MailingListRequest()
        if include_optional:
            return MailingListRequest(
                name = 'Welcome Email',
                from_email = 'no-reply@example.com',
                from_name = 'Example Company',
                contact = segnivo_sdk.models.mailing_list_request_contact.MailingListRequest_contact(
    ...
    def testMailingListRequest(self):
        """Test MailingListRequest"""
