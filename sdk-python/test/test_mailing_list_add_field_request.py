...
class TestMailingListAddFieldRequest(unittest.TestCase):
    """MailingListAddFieldRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailingListAddFieldRequest:
        """Test MailingListAddFieldRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailingListAddFieldRequest`
        """
        model = MailingListAddFieldRequest()
        if include_optional:
            return MailingListAddFieldRequest(
                type = 'text',
    ...
    def testMailingListAddFieldRequest(self):
        """Test MailingListAddFieldRequest"""
