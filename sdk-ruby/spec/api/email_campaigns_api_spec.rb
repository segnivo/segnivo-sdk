...
# Unit tests for SegnivoSDK::EmailCampaignsApi
...
describe 'EmailCampaignsApi' do
  ...
  describe 'test an instance of EmailCampaignsApi' do
    it 'should create an instance of EmailCampaignsApi' do
      expect(@api_instance).to be_instance_of(SegnivoSDK::EmailCampaignsApi)
    end
  end
  ...
  # unit tests for messages_uid_delete_post
  # Delete a campaign
  ...
  # unit tests for messages_uid_get
  # Get a campaign
  ...
  # unit tests for messages_uid_patch
  # Update Campaign
  ...
  # unit tests for messages_uid_pause_post
  # Pause a campaign
  ...
  # unit tests for messages_uid_resume_post
