...
# Unit tests for SegnivoSDK::EmailAddressVerificationApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EmailAddressVerificationApi' do
  before do
  ...
  describe 'test an instance of EmailAddressVerificationApi' do
    it 'should create an instance of EmailAddressVerificationApi' do
      expect(@api_instance).to be_instance_of(SegnivoSDK::EmailAddressVerificationApi)
    end
  end

  # unit tests for validate_email_post
