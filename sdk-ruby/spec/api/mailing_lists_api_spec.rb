...
# Unit tests for SegnivoSDK::MailingListsApi
...
describe 'MailingListsApi' do
  ...
  describe 'test an instance of MailingListsApi' do
    it 'should create an instance of MailingListsApi' do
      expect(@api_instance).to be_instance_of(SegnivoSDK::MailingListsApi)
    end
  end
  ...
  # unit tests for lists_uid_add_field_post
  # Add a field
  ...
  # unit tests for lists_uid_delete_post
  # Delete a list
  ...
  # unit tests for lists_uid_patch
  # Update a List
