...
# Unit tests for SegnivoSDK::RelayApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RelayApi' do
  before do
  ...
  describe 'test an instance of RelayApi' do
    it 'should create an instance of RelayApi' do
      expect(@api_instance).to be_instance_of(SegnivoSDK::RelayApi)
    end
  end

  # unit tests for relay_emails_id_get
  # Fetch Emails
  ...
  # @return [Object]
  describe 'relay_emails_id_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for relay_raw_post
