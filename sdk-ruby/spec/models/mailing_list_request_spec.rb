...
# Unit tests for SegnivoSDK::MailingListRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::MailingListRequest do
  let(:instance) { SegnivoSDK::MailingListRequest.new }

  describe 'test an instance of MailingListRequest' do
    it 'should create an instance of MailingListRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::MailingListRequest)
    end
  end
