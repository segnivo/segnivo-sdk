...
# Unit tests for SegnivoSDK::CampaignUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::CampaignUpdateRequest do
  let(:instance) { SegnivoSDK::CampaignUpdateRequest.new }

  describe 'test an instance of CampaignUpdateRequest' do
    it 'should create an instance of CampaignUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::CampaignUpdateRequest)
    end
  end
