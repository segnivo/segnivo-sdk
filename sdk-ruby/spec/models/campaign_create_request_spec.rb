...
# Unit tests for SegnivoSDK::CampaignCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::CampaignCreateRequest do
  let(:instance) { SegnivoSDK::CampaignCreateRequest.new }

  describe 'test an instance of CampaignCreateRequest' do
    it 'should create an instance of CampaignCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::CampaignCreateRequest)
    end
  end

  describe 'test attribute "mail_list_uid"' do
    it 'should work' do
