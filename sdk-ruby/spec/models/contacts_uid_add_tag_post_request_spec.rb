...
# Unit tests for SegnivoSDK::ContactsUidAddTagPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::ContactsUidAddTagPostRequest do
  let(:instance) { SegnivoSDK::ContactsUidAddTagPostRequest.new }

  describe 'test an instance of ContactsUidAddTagPostRequest' do
    it 'should create an instance of ContactsUidAddTagPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::ContactsUidAddTagPostRequest)
    end
  end
