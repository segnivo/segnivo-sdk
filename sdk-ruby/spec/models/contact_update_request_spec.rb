...
# Unit tests for SegnivoSDK::ContactUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::ContactUpdateRequest do
  let(:instance) { SegnivoSDK::ContactUpdateRequest.new }

  describe 'test an instance of ContactUpdateRequest' do
    it 'should create an instance of ContactUpdateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::ContactUpdateRequest)
    end
  end
