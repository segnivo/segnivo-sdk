...
# Unit tests for SegnivoSDK::MailingListAddFieldRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::MailingListAddFieldRequest do
  let(:instance) { SegnivoSDK::MailingListAddFieldRequest.new }

  describe 'test an instance of MailingListAddFieldRequest' do
    it 'should create an instance of MailingListAddFieldRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::MailingListAddFieldRequest)
    end
  end
