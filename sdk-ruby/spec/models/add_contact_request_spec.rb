...
# Unit tests for SegnivoSDK::AddContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::AddContactRequest do
  let(:instance) { SegnivoSDK::AddContactRequest.new }

  describe 'test an instance of AddContactRequest' do
    it 'should create an instance of AddContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::AddContactRequest)
    end
  end

  describe 'test attribute "list_uid"' do
    it 'should work' do
