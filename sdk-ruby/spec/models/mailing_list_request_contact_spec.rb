...
# Unit tests for SegnivoSDK::MailingListRequestContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SegnivoSDK::MailingListRequestContact do
  let(:instance) { SegnivoSDK::MailingListRequestContact.new }

  describe 'test an instance of MailingListRequestContact' do
    it 'should create an instance of MailingListRequestContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SegnivoSDK::MailingListRequestContact)
    end
  end
