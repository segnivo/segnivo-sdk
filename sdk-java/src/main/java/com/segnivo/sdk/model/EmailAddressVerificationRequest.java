 ...
 */
@JsonPropertyOrder({
  EmailAddressVerificationRequest.JSON_PROPERTY_EMAILS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class EmailAddressVerificationRequest {
  public static final String JSON_PROPERTY_EMAILS = "emails";
  @javax.annotation.Nullable
  private List<String> emails = new ArrayList<>();

  public EmailAddressVerificationRequest() {
  }

  public EmailAddressVerificationRequest emails(@javax.annotation.Nullable List<String> emails) {
    
    this.emails = emails;
    return this;
  }

  public EmailAddressVerificationRequest addEmailsItem(String emailsItem) {
    if (this.emails == null) {
  ...
  public boolean equals(Object o) {
    ...
    EmailAddressVerificationRequest emailAddressVerificationRequest = (EmailAddressVerificationRequest) o;
    return Objects.equals(this.emails, emailAddressVerificationRequest.emails);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailAddressVerificationRequest {\n");
