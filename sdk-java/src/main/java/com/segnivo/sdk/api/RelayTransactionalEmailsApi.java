...
public class RelayTransactionalEmailsApi extends BaseApi {
     ...
     */
    public Object relaySendPost(Object body) throws RestClientException {
        return relaySendPostWithHttpInfo(body).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Object> relaySendPostWithHttpInfo(Object body) throws RestClientException {
