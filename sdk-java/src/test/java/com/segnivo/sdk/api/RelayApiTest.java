...
/**
 * API tests for RelayApi
 */
@Disabled
class RelayApiTest {

    private final RelayApi api = new RelayApi();
     ...
     */
    @Test
    void relayEmailsIdGetTest() {
        String id = null;
        Integer limit = null;

        Object response = api.relayEmailsIdGet(id, limit);
     ...
     */
    @Test
    void relayRawPostTest() {
        String message = null;
        Boolean isTransactional = null;
        Boolean trackClick = null;
        Boolean trackOpen = null;
        Boolean signDkim = null;

        Object response = api.relayRawPost(message, isTransactional, trackClick, trackOpen, signDkim);
