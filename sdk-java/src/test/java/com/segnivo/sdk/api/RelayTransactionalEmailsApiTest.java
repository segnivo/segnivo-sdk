...
/**
 * API tests for RelayTransactionalEmailsApi
 */
@Disabled
class RelayTransactionalEmailsApiTest {

    private final RelayTransactionalEmailsApi api = new RelayTransactionalEmailsApi();
